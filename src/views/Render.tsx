  ...
  useEffect(() => {
    const fetchWeather = async (city?: string) => {
      if (city) {
        ...
        weather().getDailyForecast({city, days: 3, units:'metric'}).then(console.log).catch(console.error)
        weather().getHourlyForecast({city, hours: 6, units:'metric'}).then(console.log).catch(console.error)
      }
    }
